...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mezzanine_wiki_wikipage', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wikipages', to=orm['auth.User'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')()),
            ('content', self.gf('mezzanine_wiki.fields.WikiTextField')()),
            ...
            #('rating', self.gf('mezzanine.generic.fields.RatingField')(object_id_field='object_pk', to=orm['generic.Rating'])),
        ))
        db.send_create_signal('mezzanine_wiki', ['WikiPage'])

        # Adding M2M table for field categories on 'WikiPage'
        db.create_table('mezzanine_wiki_wikipage_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wikipage', models.ForeignKey(orm['mezzanine_wiki.wikipage'], null=False)),
            ('wikicategory', models.ForeignKey(orm['mezzanine_wiki.wikicategory'], null=False))
        ))
        db.create_unique('mezzanine_wiki_wikipage_categories', ['wikipage_id', 'wikicategory_id'])

        # Adding model 'WikiPageRevision'
        db.create_table('mezzanine_wiki_wikipagerevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wikipagerevisions', to=orm['auth.User'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')()),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mezzanine_wiki.WikiPage'])),
            ('content', self.gf('mezzanine_wiki.fields.WikiTextField')()),
        ))
        db.send_create_signal('mezzanine_wiki', ['WikiPageRevision'])

        # Adding model 'WikiCategory'
        db.create_table('mezzanine_wiki_wikicategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
        ))
        db.send_create_signal('mezzanine_wiki', ['WikiCategory'])


    def backwards(self, orm):
        # Deleting model 'WikiPage'
        db.delete_table('mezzanine_wiki_wikipage')

        # Removing M2M table for field categories on 'WikiPage'
        db.delete_table('mezzanine_wiki_wikipage_categories')

        # Deleting model 'WikiPageRevision'
        db.delete_table('mezzanine_wiki_wikipagerevision')

        # Deleting model 'WikiCategory'
        db.delete_table('mezzanine_wiki_wikicategory')
    ...
    models = {
        ...
        'mezzanine_wiki.wikipage': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wikipages'", 'to': "orm['auth.User']"})
        },
        'mezzanine_wiki.wikipagerevision': {
            'Meta': {'ordering': "('-date_created',)", 'object_name': 'WikiPageRevision'},
            'content': ('mezzanine_wiki.fields.WikiTextField', [], {}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mezzanine_wiki.WikiPage']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wikipagerevisions'", 'to': "orm['auth.User']"})
        },
        'sites.site': {
