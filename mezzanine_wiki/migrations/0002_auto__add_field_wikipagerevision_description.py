...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WikiPageRevision.description'
        db.add_column('mezzanine_wiki_wikipagerevision', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WikiPageRevision.description'
        db.delete_column('mezzanine_wiki_wikipagerevision', 'description')
