...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WikiPage._meta_title'
        db.add_column('mezzanine_wiki_wikipage', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WikiPage._meta_title'
        db.delete_column('mezzanine_wiki_wikipage', '_meta_title')
