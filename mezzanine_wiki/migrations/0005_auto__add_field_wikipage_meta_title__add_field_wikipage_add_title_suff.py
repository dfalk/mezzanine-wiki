...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WikiPage.meta_title'
        db.add_column('mezzanine_wiki_wikipage', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'WikiPage.add_title_suffix'
        db.add_column('mezzanine_wiki_wikipage', 'add_title_suffix',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WikiPage.meta_title'
        db.delete_column('mezzanine_wiki_wikipage', 'meta_title')

        # Deleting field 'WikiPage.add_title_suffix'
        db.delete_column('mezzanine_wiki_wikipage', 'add_title_suffix')
    ...
    models = {
        ...
        'mezzanine_wiki.wikipage': {
            ...
            'add_title_suffix': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
